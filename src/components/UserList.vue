<template>
    <div>
        ...
        >
            <b-dropdown-item
                v-for="entryOption in [5, 10, 25, 100]"
            ...
            <template #cell(passwordClear)="{ item, index }">
                <div>
                    <b-input-group>
                        ...
                        <b-button
                            variant="white"
                            @click="showPassword(item, index)"
                            v-if="item.passwordClear"
                        >
                            <b-icon
                                :icon="item.showPassword ? 'eye' : 'eye-slash'"
                            ></b-icon>
                        </b-button>
                    </b-input-group>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            showPassword(item, index) {
                Vue.set(this.items, index + this.perPage * (this.currentPage - 1), {
                    ...item,
