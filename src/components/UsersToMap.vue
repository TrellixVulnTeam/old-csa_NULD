<template>
    <div>
        <div class="mx-0 px-0">
                                    ...
                                    <b-row>
                                        <b-col>
                                            ...
                                            <ul class="list-group">
                                                ...
                                                >
                                                   <h4 class="m-2"> Subscription: {{
                                                        selectedSubscription.subscriptionName
                                                    }} 
                                                    <b-button
                                                        variant="outline-dark"
                                                        class="float-right"
                                                        v-b-toggle="'collapse-'+selectedSubscription.subscriptionID"
                                                    ...
                                                    <b-collapse :id="'collapse-'+selectedSubscription.subscriptionID" class="mt-2">
                                                        <div class="w-100 mt-4">
                                                            <b-table selectable ref="table"
                                                                    bordered
                                                                    head-variant="dark"
                                                                    class="w-100 border"
                                                            ...
                                                            <template v-slot:head()="data">
                                                                ...
                                                                <template #cell(selected)="{ rowSelected }">
                                                                    <div>
                                                                        <b-icon v-if="!rowSelected" font-scale="2" icon="check" variant="success"></b-icon>
                                                                    </div>
                                                                </template>
                                                            </b-table>
                                                        </div>
            ...
            <b-row>
                <b-col>
                    <CSACard title="Users Selected" class="w-100">
                        <template #card-body>
                            <div>
                                <user-list></user-list>
                            </div>
