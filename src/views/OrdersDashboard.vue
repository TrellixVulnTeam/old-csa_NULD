<template>
  <div class="ordersDashboard pb-5">
    ...
    <div class="">
      <b-container>
        <b-row>
          <b-col>
            <CSACard title="Orders" :bodyVisible="true" :hideCaret="true">
                  ...
                  <b-form>
                         <b-form-group
                          ...
                          <b-input-group-append>
                            <b-button variant="outline-success">Import</b-button>
                          </b-input-group-append>
                      ...
                      <h4 class="">OR</h4>
                      <b-form-group id="input-group-3" label="Orders (7):" label-for="input-3">
                        ...
                        <b-form-select
                          id="input-3"
                          :select-size="7"
                          :options="['Lake Travis Ind School Dist (00116314): Peter Romando [Renewal]', 'Shelby Co School District (00900049): Norma Miller [Renewal]', 'Warner Co School District (00900049): Norma Gromet [Renewal]', 'Dallas Co School District (00900049): Norma Manning [Renewal]', 'Ohio Co School District (00900049): Norma Tnak [Renewal]', 'asdpbjoai Co School District (00900049): Norma Smith [Renewal]', 'asdf Co School District (00900049): Norma Wallace [Renewal]']"
                          required
                        ></b-form-select>
                      </b-form-group>

                      <b-form-group id="input-group-4" label="Orders already started" label-for="input-4">
                        <b-form-select
                          id="input-4"
                          :select-size="7"
                          :options="['Lake Travis Ind School Dist (00116314): Peter Romando [Renewal]', 'Shelby Co School District (00900049): Norma Miller [Renewal]', 'Warner Co School District (00900049): Norma Gromet [Renewal]', 'Dallas Co School District (00900049): Norma Manning [Renewal]', 'Ohio Co School District (00900049): Norma Tnak [Renewal]', 'asdpbjoai Co School District (00900049): Norma Smith [Renewal]', 'asdf Co School District (00900049): Norma Wallace [Renewal]']"
                      ...
                      <b-button  variant="outline-success" v-b-modal.modal-contractnumber>Import</b-button>
            ...
            <b-modal id="modal-contractnumber" title="Confirm Subscription to import">

              <h5 class="text-center display-5 ">Contract #: 00116314</h5>
              <p class="mb-5 text-secondary text-center">Lake Travis Ind School Dist (00116314): Peter Romando [Renewal] Frax</p>
              <b-form-group
                id="contractnumber"
                label="Confirm #:"
        ...
        label-align-sm="right"
              ...
              <b-alert show variant="danger">
                Error, the account number you entered is <b-link>Shelby Co School District (<strong>01116314</strong>): Norma Miller [Renewal] Reflex (click to import this school instead)</b-link>
              </b-alert>
              ...
              <b-button variant="outline" href="#/merge">skip</b-button>
              <b-button variant="success" disabled>Confirm</b-button>
                </div>
              </template>
            </b-modal>
          </b-col>
          <b-col>
            <CSACard title="Quick Search" bodyVisible hideCaret>
              <template #card-body>
                <div>
                   <b-input-group prepend="Contact #:" class="mt-3">
                          <b-form-input></b-form-input>
                    ...
                    <b-input-group prepend="Subscription name:" class="mt-3">
                      <b-form-input></b-form-input>
          ...
          <CSACard title="Quick Create"  class="mt-4" bodyVisible hideCaret>
            <template #card-body>
              <div>
                <b-button variant="success">Create Standalone Umbrella</b-button>
              </div>
            </template>
          </CSACard>

          
          <CSACard title="History Log" class="w-100">
            <template #card-body>
              <AuditLog></AuditLog>
            </template>
          </CSACard>
